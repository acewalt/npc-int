...
(function(){
  ...
  function evaluate(b,meta={}){
    ...
    const minAfterUser=urgent?0:Math.round(120000+(1-(relation.comfort??.35))*60000);
    const minAfterNpc=urgent?0:90000;
    const initiativeCooldown=urgent?0:Math.round(180000+(1-(relation.familiarity??.1))*120000);
  ...
  print("system","","timing social v1.3 cargado · presencia conversacional + pausa larga antes de iniciativa autónoma");
})();
